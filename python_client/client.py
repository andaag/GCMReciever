...
msg = lib.createMsg(args.title, message=args.message, delay_while_idle=delay_while_idle, expires=args.expires,
                    icon=args.icon, iconBackground=args.iconBackground, collapseKey=args.collapseKey)
print msg
lib.sendMsg(msg)